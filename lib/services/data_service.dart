...
class DataService {
  ...
  final _products = const [
    ...
    Product(
      ...
      price: 17.99,
      imageUrl: 'https://images.stockx.com/images/Corteiz-Web-Alcatraz-Tee-Black.jpg?fit=fill&bg=FFFFFF&w=700&h=500&fm=webp&auto=compress&q=90&dpr=2&trim=color&updated_at=1699041460',
      isLocalImage: false,
      collectionId: 'tshirts',
      sizes: ['S', 'M', 'L', 'XL'],
      images: [
        'https://images.stockx.com/images/Corteiz-Web-Alcatraz-Tee-Black.jpg?fit=fill&bg=FFFFFF&w=700&h=500&fm=webp&auto=compress&q=90&dpr=2&trim=color&updated_at=1699041460',
        'https://images.stockx.com/images/Corteiz-Alcatraz-Heart-Tee-White.jpg?fit=fill&bg=FFFFFF&w=1200&h=857&q=60&dpr=1&trim=color&updated_at=1707765429',
      ],
      colors: ['Black', 'White'],
    ),
    Product(
    ...
    Product(
      ...
      price: 9.99,
      strikePrice: 12.99,
      imageUrl: 'https://rewindvintage.co.uk/cdn/shop/products/purplebirkin.png?v=1713975625',
      isLocalImage: false,
      collectionId: 'accessories',
      sizes: [],
      images: [
        'https://rewindvintage.co.uk/cdn/shop/products/purplebirkin.png?v=1713975625',
        'https://bagista.co.uk/cdn/shop/files/SOR5025-HERMES-BIRKIN30-BLEUNAVYTOGOPHW_7082.jpg?v=1715266444&width=1946',
      ],
      colors: ['Purple', 'Navy'],
    ),
    Product(
      ...
      price: 5.99,
      imageUrl: 'https://m.media-amazon.com/images/I/71W5jyn6yzL.jpg',
      isLocalImage: false,
      collectionId: 'stationery',
      sizes: [],
      images: [
        'https://m.media-amazon.com/images/I/71W5jyn6yzL.jpg',
        'https://i.ebayimg.com/images/g/brcAAeSwUW1o3Mw4/s-l400.jpg',
      ],
    ),
    Product(
      id: 'pen-gel',
